...
def app():
    ...
    st.subheader("Karen Arroyo")
    
    st.subheader('Do you believe that technology is exacerbating social isolation and creating a sense of disconnection among individuals from their communities?')
